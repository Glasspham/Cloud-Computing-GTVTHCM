...
#### Bước 3: Chạy Docker
SSH vào máy Azure, di chuyển vào thư mục `BTL` và chạy lệnh sau:
```bash
ssh glass@[IP] "cd ~/BTL && docker compose up -d --build"
```

_Ví dụ:_
```bash
ssh glass@20.235.122.97 "cd ~/BTL && docker compose up -d --build"
```
